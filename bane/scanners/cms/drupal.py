...
def get_drupal_infos(u,user_agent=None,cookie=None,timeout=10,logs=True,crt_timeout=120,wayback_timeout=120,subdomain_check_timeout=10,max_wayback_urls=10,subdomains_only=True,headers={},api_key=None,http_proxies=None,socks4_proxies=None,socks5_proxies=None):
    ...
    if version!='':
        ...
        wpvulns=vulners_search('drupal',version=version,proxy=setup_proxy(proxies),api_key=api_key)
        for x in wpvulns:
